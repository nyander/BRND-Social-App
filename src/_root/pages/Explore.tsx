...
const Explore = () => {
  ...
  const shouldShowPost = !shouldShowSearchResults && posts.pages.every((item) => item ? item.documents.length === 0 : false)
    ...
    <div className='explore-container'>
      ...
      <div className='flex-between w-full max-w-5xl mt-16 mb-7'>
        ...
        <div className='flex-center gap-3 bg-dark-3 rounded-xl px-4 py-2 cursor-pointer'>
          ...
          <img src="/assets/icons/filter.svg" alt="fitler" width={20} height={20}/>
        </div>
      </div>
